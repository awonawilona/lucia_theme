 ...
 *
 * Be sure to replace all instances of 'drluciatheme_' with your project's prefix.
 * http://nacin.com/2010/05/11/in-wordpress-prefix-everything/
 *
 * @category drluciatheme
 * @package  Demo_CMB2
 ...
 */
function drluciatheme_show_if_front_page( $cmb ) {
 ...
 * @return bool              True if metabox should show
 */
function drluciatheme_hide_if_no_cats( $field ) {
 ...
 */
function drluciatheme_render_row_cb( $field_args, $field ) {
 ...
 * @param  CMB2_Field $field      The field object.
 */
function drluciatheme_display_text_small_column( $field_args, $field ) {
	?>
 ...
 * @param  CMB2_Field $field      Field object.
 */
function drluciatheme_before_row_if_2( $field_args, $field ) {
...
add_action( 'cmb2_admin_init', 'drluciatheme_register_demo_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_admin_init' or 'cmb2_init' hook.
 */
function drluciatheme_register_demo_metabox() {
	$prefix = 'drluciatheme_demo_';
	...
	$cmb_demo = new_cmb2_box( array(
		...
		// 'show_on_cb' => 'drluciatheme_show_if_front_page', // function should return a bool value
		// 'context'    => 'normal',
		// 'priority'   => 'high',
		...
		// 'classes_cb' => 'drluciatheme_add_some_classes', // Add classes through a callback.
	) );
	...
	$cmb_demo->add_field( array(
		...
		'id'         => $prefix . 'text',
		'type'       => 'text',
		'show_on_cb' => 'drluciatheme_hide_if_no_cats', // function should return a bool value
	...
	$cmb_demo->add_field( array(
		...
		// );
		// 'display_cb' => 'drluciatheme_display_text_small_column', // Output the display of the column values through a callback.
	) );
	...
	$cmb_demo->add_field( array(
		...
		'type' => 'text',
		'render_row_cb' => 'drluciatheme_render_row_cb',
	) );
	...
	$cmb_demo->add_field( array(
		...
		'type'         => 'text',
		'before_row'   => 'drluciatheme_before_row_if_2', // callback.
...
add_action( 'cmb2_admin_init', 'drluciatheme_register_about_page_metabox' );
/**
 * Hook in and add a metabox that only appears on the 'About' page
 */
function drluciatheme_register_about_page_metabox() {
	$prefix = 'drluciatheme_about_';
...
add_action( 'cmb2_admin_init', 'drluciatheme_register_repeatable_group_field_metabox' );
/**
 * Hook in and add a metabox to demonstrate repeatable grouped fields
 */
function drluciatheme_register_repeatable_group_field_metabox() {
	$prefix = 'drluciatheme_group_';
...
add_action( 'cmb2_admin_init', 'drluciatheme_register_user_profile_metabox' );
/**
 * Hook in and add a metabox to add fields to the user profile pages
 */
function drluciatheme_register_user_profile_metabox() {
	$prefix = 'drluciatheme_user_';
...
add_action( 'cmb2_admin_init', 'drluciatheme_register_taxonomy_metabox' );
/**
 * Hook in and add a metabox to add fields to taxonomy terms
 */
function drluciatheme_register_taxonomy_metabox() {
	$prefix = 'drluciatheme_term_';
...
add_action( 'cmb2_admin_init', 'drluciatheme_register_theme_options_metabox' );
/**
 * Hook in and register a metabox to handle a theme options page and adds a menu item.
 */
function drluciatheme_register_theme_options_metabox() {

	/**
	 * Registers options page menu item and form.
	 */
	$cmb_options = new_cmb2_box( array(
		'id'           => 'drluciatheme_theme_options_page',
		...
		'option_key'      => 'drluciatheme_theme_options', // The option key and admin menu page slug.
		...
		// 'message_cb'      => 'drluciatheme_options_page_message_callback',
 ...
 * }
 */
function drluciatheme_options_page_message_callback( $cmb, $args ) {
 ...
 */
function drluciatheme_limit_rest_view_to_logged_in_users( $is_allowed, $cmb_controller ) {
...
add_action( 'cmb2_init', 'drluciatheme_register_rest_api_box' );
/**
 ...
 */
function drluciatheme_register_rest_api_box() {
	$prefix = 'drluciatheme_rest_';
	...
	$cmb_rest = new_cmb2_box( array(
		...
		// 'get_box_permissions_check_cb' => 'drluciatheme_limit_rest_view_to_logged_in_users',
	) );
